...
elseif (NOT EMSCRIPTEN)
    ...
    # For Emscripten we only need glslc and SPIRV2C to build shaders
    find_program(GLSLC
        NAMES glslc
        PATHS
        ${VULKAN_SDK}/Bin
...
if (EMSCRIPTEN)
    set(PREV_FIND_ROOT_PATH_MODE_LIBRARY ${CMAKE_FIND_ROOT_PATH_MODE_LIBRARY})
    set(PREV_FIND_ROOT_PATH_MODE_INCLUDE ${CMAKE_FIND_ROOT_PATH_MODE_INCLUDE})
...
if (EMSCRIPTEN)
    set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ${PREV_FIND_ROOT_PATH_MODE_LIBRARY})
    set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ${PREV_FIND_ROOT_PATH_MODE_INCLUDE})
endif()
...
if (NOT EMSCRIPTEN)
    find_package_handle_standard_args(Vulkan
        DEFAULT_MSG Vulkan_LIBRARY Vulkan_INCLUDE_DIR GLSLC SPIRV2C)
else()
    find_package_handle_standard_args(Vulkan
        DEFAULT_MSG GLSLC SPIRV2C)
endif()
